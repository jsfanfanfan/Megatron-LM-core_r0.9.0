...
gbs=4, tp=1, pp=4, dp=1 freeze-LM
    26-4-4-4 1225 ms/iteration
    峰值显存占用:8.68G-8.51G-6.50G-5.47G
    前向传播时间:210-272-264-333
    反向传播时间:250-311-311-372

    26-8-8-8 2000 ms/iteration
    前向传播时间:210-520-516-575
    反向传播时间:250-620-625-683

gbs=4, tp=1, pp=4, dp=1 no-freeze

    26-4-4-4 1582 ms/iteration
    前向传播时间:210-272-264-333
    反向传播时间:250-524-520-619

    26-2-2-2 963 ms/iteration
    前向传播时间:210-140-140-201
    反向传播时间:250-265-258-363

    1-23-2-2 793ms/iteration
    30-180-23-203 
    26-196-25-377

    2-22-2-2 793ms/iteration
    39-171-23-203 
    26-196-25-377
...
gbs=4, tp=1, pp=4, dp=1 freeze-ViT

    26-4-4-4 793ms/iteration
    30-180-23-203 
    26-196-25-377



1.冻结对于 transformer 层的反向传播时间的影响大致降为原来的一半,实际测试中在 0.5-0.6 倍之间,这导致冻结后的层反向传播的时间略低于前向传播的时间

2.如果冻结最前面的模块(encoder), encoder 貌似不参与反向传播, 反向传播时间几乎为 0 
